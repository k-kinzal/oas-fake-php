...
final class ParameterSerializerTest extends TestCase
{
    ...
    public function testQuerySerializesExplodedLists(): void
    {
        ...
        self::assertSame(['tags' => ['1', 'true']], (new ParameterSerializer())->query($parameter, [1, true]));
    }
    ...
    public static function providerQueryStyles(): iterable
    {
        ...
        yield 'simple structured value' => [
            ['name' => 'filter', 'in' => 'query', 'style' => 'simple', 'explode' => false],
            ['name' => 'Buddy'],
            ['filter' => '{"name":"Buddy"}'],
        ];
    ...
    public static function providerDelimitedValues(): iterable
    {
        ...
        yield 'list' => [[true, false], '|', false, 'true|false'];
